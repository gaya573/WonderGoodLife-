...
import './PrepurchaseDealDetail.css';
...
const PrepurchaseDealDetail = () => {
  ...
  const estimateMonthly = () => {
    ...
    return Math.max(1, Math.round((financed / termNum) / 10000));
  };
            ...
            <section className="compare-section">
              <div className="estimate-card compare-left">
                <div className="estimate-topbar">
                  <span className="estimate-topbar-title">선구매 핫딜</span>
                </div>
              ...
              <div className="estimate-card compare-right">
                <div className="estimate-topbar" style={{background:'#f1f3f5', color:'#333'}}>
                  <span className="estimate-topbar-title">일반 렌트 견적</span>
                </div>
                {renderPaymentDetails()}
