...
const CarList = () => {
  ...
  const domesticCars = [
    { name: "더 뉴 팰리세이드", price: 45, priceText: "월 45만원~", img: "https://images.unsplash.com/photo-1519641471654-76ce0107ad1b?w=300&h=200&fit=crop" },
    { name: "쏘렌토 하이브리드", price: 42, priceText: "월 42만원~", img: "https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?w=300&h=200&fit=crop" },
    { name: "투싼 하이브리드", price: 39, priceText: "월 39만원~", img: "https://images.unsplash.com/photo-1552519507-da3b142c6e3d?w=300&h=200&fit=crop" },
    { name: "GV80", price: 89, priceText: "월 89만원~", img: "https://images.unsplash.com/photo-1606664515524-ed2f786a0bd6?w=300&h=200&fit=crop" },
    { name: "K8", price: 44, priceText: "월 44만원~", img: "https://images.unsplash.com/photo-1617531653332-bd46c24f2068?w=300&h=200&fit=crop" },
    { name: "그랜저 IG", price: 40, priceText: "월 40만원~", img: "https://images.unsplash.com/photo-1617531653520-bd466e19bc3e?w=300&h=200&fit=crop" },
  ];

  const importedCars = [
    { name: "BMW X5", price: 95, priceText: "월 95만원~", img: "https://images.unsplash.com/photo-1555215695-3004980ad54e?w=300&h=200&fit=crop" },
    { name: "Mercedes-Benz E-Class", price: 85, priceText: "월 85만원~", img: "https://images.unsplash.com/photo-1618843479313-40f8afb4b4d8?w=300&h=200&fit=crop" },
    { name: "Audi Q7", price: 92, priceText: "월 92만원~", img: "https://images.unsplash.com/photo-1606016159991-5de14d7a9ac0?w=300&h=200&fit=crop" },
    { name: "Lexus RX", price: 75, priceText: "월 75만원~", img: "https://images.unsplash.com/photo-1621007947382-bb3c3994e3fb?w=300&h=200&fit=crop" },
    { name: "Volvo XC90", price: 80, priceText: "월 80만원~", img: "https://images.unsplash.com/photo-1617654112368-307921291f42?w=300&h=200&fit=crop" },
    { name: "Porsche Cayenne", price: 120, priceText: "월 120만원~", img: "https://images.unsplash.com/photo-1614200187524-dc4b892acf16?w=300&h=200&fit=crop" },
  ];
      ...
      <div className="carlist-container">
        ...
        <div className="carlist-main-layout">
          ...
          <main className="carlist-main">
            ...
            {/* 차량 카드 리스트 */}
            <CarGrid cars={filteredAndSortedCars} onClickCard={handleCarClick} />
          </main>
        </div>
      </div>
    </div>
