...
import { findCardBrandById } from './data';
import './CardPromotionDetail.css';

const CardPromotionDetail = () => {
  const { id } = useParams();
  ...
  const card = findCardBrandById(id);
...
export default CardPromotionDetail;
